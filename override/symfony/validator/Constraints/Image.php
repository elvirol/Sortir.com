...
class Image extends File
{
    ...
    public $mimeTypesMessage = "Ce fichier n'est pas un format valide d'image.";
    public $sizeNotDetectedMessage = "La taille de l'image ne peut pas être détecté.";
    public $maxWidthMessage = "L'image est trop large ({{ width }}px). La taille maximum autorisé est {{ max_width }}px.";
    public $minWidthMessage = "L'image est pas assez large ({{ width }}px). La taille minimale autorisé est {{ min_width }}px.";
    public $maxHeightMessage = "L'image est trop haute ({{ height }}px). La hauteur maximale est {{ max_height }}px.";
    public $minHeightMessage = "L'image est pas assez haute ({{ height }}px). La hauteur minimale est {{ min_height }}px.";
    public $minPixelsMessage = "L'image n'a pas assez de pixels ({{ pixels }} pixels). Le minimum de pixel est {{ min_pixels }} pixels.";
    public $maxPixelsMessage = "L'image a trop de pixels ({{ pixels }} pixels). Le maximum de pixel est {{ max_pixels }} pixels.";
    public $maxRatioMessage = "Le ratio de l'image est trop grand ({{ ratio }}). Le ratio maximum est {{ max_ratio }}.";
    public $minRatioMessage = "Le ratio de l'image est trop petit ({{ ratio }}). Le ratio minimum est {{ min_ratio }}.";
    public $allowSquareMessage = "L'image est un carré ({{ width }}x{{ height }}px). Les images carrés ne sont pas autorisées.";
    public $allowLandscapeMessage = "L'image est en mode paysage ({{ width }}x{{ height }}px). Ce mode n'est pas autorisé.";
    public $allowPortraitMessage = "L'image est en mode portrait ({{ width }}x{{ height }}px). Ce mode n'est pas autorisé.";
